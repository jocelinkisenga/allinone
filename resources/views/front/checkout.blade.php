                    ...
                    <div class="checkout-form">
                        ...
                        <form class="form" method="post" action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>Etat / Division<span>*</span></label>
                                        <select name="state-province" id="state-province">
                                            <option value="divition" selected="selected">Lubumbashi</option>
                                            <option>Likasi</option>
                                            <option>Kolwezi</option>
                                            <option>Kipushi</option>
                                            <option>Kalemi</option>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="company_name" id="company">
                                            <option value="company" selected="selected">Total</option>
                                            <option>Shell</option>
                                            <option>Chevron</option>
                                            <option>valvoni</option>
                ...
                <div class="col-lg-4 col-12">
                    <div class="order-details">
                        ...
                        <div class="single-widget">
                            ...
                            <div class="content">
                                <ul>
                                    <li>Total partiel<span>$50099.00</span></li>
                                    <li>(+) Expédition<span>$1000.00</span></li>
                                    <li class="last">Total<span>$51099.00</span></li>
                                </ul>
                            </div>
                        </div>
                        <!--/ End Order Widget -->

            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        ...
                        <div class="logo">
                            <a href="/">
                                <p class="font-weight-light">Hazetu Petroleum</p>
                            </a>
                        </div>
                        <!--/ End Logo -->
                        <!-- Search Form -->
                    ...
                    <div class="col-lg-2 col-md-3 col-12">
                        <div class="right-bar">
                            ...
                            <div class="sinlge-bar">
                                @auth
                                    <a href="{{ route('client.profile') }}" class="single-icon" title="profile"><i
                                            class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                                @endauth
                                @guest
                                    <a href="{{ route('login') }}" class="single-icon" title="login"><i
                                            class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                                @endguest
                            ...
                            <div class="sinlge-bar shopping">
                                <a href="#" class="single-icon"><i class="ti-bag"></i> <span
                                        class="total-count">@livewire('cardcounter')</span></a>
                                <!-- Shopping Item -->
                                    ...
                                    <div class="navbar-collapse">
                                        <div class="nav-inner">
                                            <ul class="nav main-menu menu navbar-nav align-items-center">
                                                ...
                                                <li><a href="{{ route('fournisseurs') }}">Liste de Fournisseur</a>
                                                </li>
                                                @auth
                                                    @if (Auth::user()->role_id == App\Enums\RoleEnum::ADMIN)
                                                        <li><a href="{{ route('admin.dashboard') }}">DASHBOARD</a></li>
                                                    @endif
                                                    @if (Auth::user()->role_id == App\Enums\RoleEnum::MANAGER)
                                                        <li><a href="{{ route('manager.dashboard') }}">DASHBOARD</a></li>
                                                    @endif
                                                    <li>
                                                        <form action="{{ route('logout') }}" method="POST">
                                                            @csrf
                                                            <input class="ml-4 btn bg-danger btn-danger text-white"
                                                                type="submit" value="se deconnecter">
                                                        </form>
                                                    </li>
                                                @endauth
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-12">
                        ...
                        <div class="single-footer about">
                            <div class="logo">
                                <a href="index.html">
                                    <h5>Presentation Entreprise</h5>
                                </a>
                            </div>

                            <p class="text">Habari Zetu Services est une entreprise lancée en Décembre 2018 au
                                registre de commerce CD/LSH/RCCM/18-A-00748 et elle est basée à Lubumbashi en République
                                Démocratique du Congo.</p>
                            <p class="call">Question? Appellez nous 24/7<span><a href="tel:+243975501066">+243 97 55
                                        010 66</a></span></p>
                        </div>
                        <!-- End Single Widget -->
                    </div>
